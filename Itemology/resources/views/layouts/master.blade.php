        ...
        <div class="container">
            <nav class="navbar navbar-expand-lg navbar-dark bg-dark">
                ...
                <div class="collapse navbar-collapse" id="navbarNavDropdown">
                    <ul class="navbar-nav">
                        <li class="nav-item active"><span class="sr-only">(current)</span><a class="nav-link" href="{{route('items.index')}}">All items</a></li>
                        ...
                        <li class="nav-item">
                            ...
                            <a class="nav-item" href="#">
                                <svg color="white" xmlns="http://www.w3.org/2000/svg" width="20" height="20" fill="currentColor" class="bi bi-cart" viewBox="0 0 16 16">
                ...
                <div class="text-end">
                    ...
                    <button>
                        <svg xmlns="http://www.w3.org/2000/svg" width="30" heigh="30" fill="" class="bi bi-person" viewBox="0 0 16 16">
    ...
    <div class="container">
        <footer class="py-3 my-4">
            <ul class="nav justify-content-center border-bottom pb-3 mb-3">
                <!-- <li class="nav-item"><a href="/items" class="nav-link px-2 text-muted">Catalogo</a></li>
                <li class="nav-item"><a href="/FAQ" class="nav-link px-2 text-muted">FAQs</a></li>
                <li class="nav-item"><a href="/knowUs" class="nav-link px-2 text-muted">Conocenos</a></li> -->
            </ul>
            <p class="text-center text-muted">© 2022 Item company, Inc</p>
        </footer>
    </div>
