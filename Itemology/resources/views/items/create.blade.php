    ...
    <div class="container">
        ...
        <form action="{{route('items.create')}}" method="POST">
            ...
            <div class="form-group">
                ...
                <div class="">
                    <label for="synopsis">
                        <textarea class="form-control" type="text" cols="30" rows="10" name="synopsis" placeholder="add text">{{old('synopsis')}}</textarea>
                    </label>
                    @error('synopsis')
                    <br><small>{{$message}}</small><br>
                    @enderror
                ...
                <div class="row ">
                    ...
                    <div class="form-group mb-8 col">
                        <label for="duration">
                            <input class="form-control col-8" type="number" name="duration" id="duration" placeholder="time" value="{{old('duration')}}">
                        </label>
                        @error('duration')
                        <br>
                        <small>{{$message}}</small>
